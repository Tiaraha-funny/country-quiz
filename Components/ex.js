...
function App() {
    const [countries, setCountries] = useState([]); Ok
    const [randomCountry, setRandomCountry] = useState({}); Ok
    const [randomAnswerOption, setRandomAnswerOption] = useState([]); Ok
    const [score, setScore] = useState(0); Ok
    const [IsNext, setIsNext] = useState(false); Ok
    const [IsResult, setIsResult] = useState(false); Ok
    
    const [isAnswerShown, setIsAnswerShown] = useState(false); Ok
    const [IsStart, setIsStart] = useState(false); Ok
    const [number, setNumber] = useState(0); Ok
    const rightAnswer = useRef(null); Ok
